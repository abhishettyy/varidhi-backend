...
3. EVIDENCE-BACKED: Base all advice strictly on the assembled evidence. Acknowledge missing data points transparently.
4. ACTIONABLE: Conclude every advisory with concrete recommendations.
"""
...
- Explain sea roughness simply: 'Calm', 'Slightly rough', 'Dangerous rough sea'.
...
- Discuss biophysical correlation (e.g. SST thermal fronts coinciding with Chlorophyll peaks).
